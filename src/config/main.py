...
def init():
    ...
    infos = [
        ...
        info('导出设置', '文件名格式',      'output.nformat', 'A3', output.n_main, output.n_value),
        ...
        info('图像装裱', '边距宽度',        'mounting.width', 'H1', mounting.margin_main, mounting.margin_value),
        info('图像装裱', '边距高度',        'mounting.height', 'H2', mounting.margin_main, mounting.margin_value),
        info('图像装裱', '裱褙颜色',        'mounting.color', 'H3', mounting.set_color, mounting.get_color),
    ]
...
def default():
    global Config
    Config = {
        'output.ddir'               : wrapper('桌面'),
        'output.fformat'            : wrapper('*.JPG'),
        'output.nformat'            : wrapper('o_{N}{E}'),
        ...
        'mounting.width'            : wrapper(0.1),
        'mounting.height'           : wrapper(0.08),
        'mounting.color'            : wrapper('#FFFFFFFF'),
        'mounting.enwatermark'      : wrapper(False),
    }
